...
public class Easy_01 extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.easy_01);
        ...
        level_text = getResources().getString(R.string.text_of_level_01);
        ...
        switch1.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                int default_color = switch2.getDrawingCacheBackgroundColor();
        ...
        text_of_level = (TextView)findViewById(R.id.level_01);
    ...
    private void Save_it() {
        editor.putBoolean(IF_EASY_LEVEL_01_SOLVED, if_01);
        editor.apply();
    }
