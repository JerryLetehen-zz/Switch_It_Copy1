...
public class Easy_04 extends AppCompatActivity implements View.OnClickListener, Switch.OnCheckedChangeListener, View.OnTouchListener  {
...
//    boolean if_04;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.easy_04);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            ...
            case R.id.switch3:
                if (if_after_sw2) {
                    if_after_sw2 = true;//Still true 'cuz it's need
                } else {
                    if_after_sw3 = true;
                    switch1.toggle();
                }
